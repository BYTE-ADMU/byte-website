...
const Gallery = ({ images }) => (
    <div className="md:w-full w-2/3 h-auto flex flex-col justify-center items-end content-center relative xl:py-32 lg:py-24 md:py-16 py-28">
      <img className="xl:w-96 xl:h-60 lg:w-64 lg:h-40 w-40 h-24 rounded-lg absolute top-0 left-0 z-10 community-image" src={images[0]} />
      <img className="xl:w-96 xl:h-60 lg:w-64 lg:h-40 w-40 h-24 rounded-lg z-20 community-image" src={images[1]} />
      <img className="xl:w-96 xl:h-60 lg:w-64 lg:h-40 w-40 h-24 rounded-lg absolute bottom-0 left-0 z-30 community-image" src={images[2]} />
    </div>
  )
  ...
  const Testimonial = ({ testimonial }) => (
    <div className="w-full h-auto flex justify-center items-center content-center">
      <div className="xl:w-2/3 lg:w-full h-auto flex flex-col justify-center items-center content-center md:m-0 mb-4">
        <img className="w-full h-auto m-0 rounded-t-2xl" src={testimonial.image} />
  ...
  const Startups = ({ startups }) => (
    <div className="lg:w-2/3 md:w-full w-3/4 h-auto flex flex-col justify-center items-end content-center relative xl:py-32 lg:py-24 py-16">
      <img className="xl:w-48 xl:h-48 w-32 h-32 rounded-full absolute top-0 left-0 z-10 community-image" src={startups[0].logo} />
      <img className="xl:w-48 xl:h-48 w-32 h-32 rounded-full z-20 community-image" src={startups[1].logo} />
      <img className="xl:w-48 xl:h-48 w-32 h-32 rounded-full absolute bottom-0 left-0 z-30 community-image" src={startups[2].logo} />
    </div>
  )
