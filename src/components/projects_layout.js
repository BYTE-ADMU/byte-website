      ...
      ?
        <>
          <div className="md:w-2/5 xl:h-96 lg:h-64 h-auto flex flex-row sm:flex sm:flex-col justify-center items-center content-center relative xl:py-32 lg:py-24 md:py-16 sm:py-8 py-4">
            <img className="mr-1 sm:mr-0 xl:w-96 xl:h-60 md:w-64 md:h-40 lg:py-0 sm:py-2 py-0 w-1/2 h-full rounded-2xl lg:absolute lg:top-0 lg:left-0 z-10" src={data.node.image_1.url} />
            <img className="ml-1 sm:ml-0 xl:w-96 xl:h-60 md:w-64 md:h-40 lg:py-0 sm:py-2 py-0 w-1/2 h-full rounded-2xl lg:absolute lg:bottom-0 lg:right-0 z-20" src={data.node.image_2.url} />
          </div>
